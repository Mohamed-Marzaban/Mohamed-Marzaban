...
☕ Professional **Java Developer**, turning coffee into clean, scalable code  
🚀 Specialized in **Java**, OOP, Data Structures, and backend system design  
...
> Things I’ve built, broken, fixed, and improved — sometimes twice 😄
...
> Implemented a **Genetic Algorithm from scratch** to simulate flower evolution across generations.  
...
> Implemented face eye-region detection using **Integral Images** and a custom convolution kernel.  
...
> Implemented **SUSAN corner detection** and **Convex Hull–based automatic thresholding** from scratch.  
...
- 🤖 **Introduction to Machine Learning**  
  Supervised & unsupervised learning, feature engineering, model evaluation, and regularization.
